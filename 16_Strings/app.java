...
// System.out.println(s1 ==s2); // true --> because when we are decelaring this two string withour new keyword so both the string is pointing towarech each other 
// System.out.println(s1 ==s3); // false  -- > here it is false due to new keyword so the adress of both of the string is differnt 
//  the concept used is interning 
//  == checks at object level to compare the values and not the address
//  so we use method as equals

// System.out.println(s1.equals(s3)); // now it is comparing the values  not the adress of the obejct 
...
// ? due to immutablity nature os string there is a differnt data structure caleeed stringbuilder
